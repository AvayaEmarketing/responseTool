...
(function($) {
	...
	$.prettyLoader = function(settings) {
		settings = jQuery.extend({
			...
			loader: 'images/ajax-loader.gif', /* Path to your loader gif */
		...
		$.prettyLoader.positionLoader = function(e){
			...
			var left_pos = cur_x + settings.offset_left + scrollPos['scrollLeft'];
			var top_pos = cur_y + settings.offset_top + scrollPos['scrollTop'];
